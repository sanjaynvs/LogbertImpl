...
def session_window(data_dir, datatype, sample_ratio=1):
    event2semantic_vec = read_json(data_dir + 'openstack/event2semantic_vec.json')
    result_logs = {}
    result_logs['Sequentials'] = []
    result_logs['Quantitatives'] = []
    result_logs['Semantics'] = []
    ...
    if datatype == 'train':
        data_dir += 'openstack/robust_log_train.csv'
    elif datatype == 'val':
        data_dir += 'openstack/robust_log_valid.csv'
    elif datatype == 'test':
        data_dir += 'openstack/robust_log_test.csv'
