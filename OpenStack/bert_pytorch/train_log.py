...
class Trainer():
    ...
    def train(self):
        ...
        print("logkey_train size: ", len(logkey_train))
    ...
    def start_iteration(self, surfix_log):
        ...
        for epoch in range(self.epochs):
            ...
            print("in start_iteration, self.train_data_loader: ", len(self.train_data_loader))
            ...
            print(f"avg_loss: {avg_loss}, best_loss: {best_loss}")
